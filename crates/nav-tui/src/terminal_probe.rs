...
//!
//! Nav currently calls [`default_colors`] at startup. The batched [`startup`] API
//! is retained for parity with codex-tui and its unit tests. OSC 10/11 probing may
//! not work inside tmux's emulated PTY; callers should fall back to fixed theme RGBs.
#![allow(dead_code)]
//!
