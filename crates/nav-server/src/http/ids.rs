...
use nav_types::{
    ApprovalId, EventId, FileChangeId, MessageId, RequestId, RunId, SessionId, ToolCallId,
};
...
impl ProtocolIdSource {
    ...
    pub(super) fn next_file_change_id(&mut self) -> FileChangeId {
        FileChangeId::try_new(self.next_uuid_v7_string())
